...
import Backup from "../images/images.jpg"
 ...
 const Moviedetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=e1e04b5be017770809ddfd448f458b65&language=en-US&page=1`);
